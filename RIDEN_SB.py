            ...
            if msg.toType == 0 or msg.toType == 2:
                ...
                if msg.contentType == 0:
                    if Squad["autoRead"] == True:
                        ...
                        elif rfuText.lower().startswith("kick on"):
                            if user in RfuSekawan or user in Squad["Admin"]:
                                Squad["KickOn"] = True
                                cl.sendText(kirim,"Status:\n{''cancel'':0,''kick'':1}")
                        elif rfuText.lower().startswith("kick off"):
                            if user in RfuSekawan or user in Squad["Admin"]:
                                Squad["KickOn"] = False
                                cl.sendText(kirim,"Status:\n{''cancel'':0,''kick'':0}")
                        ...
                        elif rfuText.lower().startswith("banlist"):
                            if user in RfuSekawan or user in Squad["Admin"]:
                                if Squad["Blacklist"] == {}:
